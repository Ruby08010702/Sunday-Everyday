...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $restockingOrder->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $restockingOrder->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="restockingOrders form content">
            ...
            <fieldset>
                <legend><?= __('Edit Restocking Order') ?></legend>
                <?php
